        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(txt_username) || TextUtils.isEmpty(txt_email) || TextUtils.isEmpty(txt_username)){
                    Toast.makeText(RegisterActivity.this, "All field are empty", Toast.LENGTH_SHORT).show();
                }else  if (txt_pass.length()>6){
                    Toast.makeText(RegisterActivity.this, "Must be minimum 6 character ", Toast.LENGTH_SHORT).show();
                }else {
                        ...
                        if (task.isSuccessful()){
                            ...
                            reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()){
                                        Intent intent=new Intent(RegisterActivity.this, UserApplication.class);
