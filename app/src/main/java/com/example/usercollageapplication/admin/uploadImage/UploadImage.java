package com.example.usercollageapplication.admin.uploadImage;
...
public class UploadImage extends AppCompatActivity {
    ...
    private Spinner spinner_imageCategory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner_imageCategory.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item,items));

        spinner_imageCategory.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                category = spinner_imageCategory.getSelectedItem().toString();
            }
    ...
    private void uploadData() {
        ...
        reference.child(uniqueKey).setValue(downloadUrl).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                startActivity(new Intent(UploadImage.this, Admin.class));
                finish();
            }
    ...
    private void assign() {
        ...
        spinner_imageCategory = findViewById(R.id.spinner_imageCategory);
